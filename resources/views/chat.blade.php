    ...
    <div class="side-panel">
        ...
        <div class="side-header">
            <div class="avatar" id="ava_id"><img src="{{ auth()->user()->photo ? asset('storage/img/' . auth()->user()->photo) : asset('storage/img/default.jpeg') }}" alt="Avatar" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;"></div>
